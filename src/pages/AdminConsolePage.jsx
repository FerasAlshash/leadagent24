...
export default function AdminConsolePage({ 
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-2xs p-6 sm:p-8 relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-2xl bg-purple-50 border border-purple-200 text-purple-700 flex items-center justify-center shrink-0 shadow-2xs mt-0.5">
              <ShieldCheck className="w-6 h-6 text-purple-600" />
            </div>
            <div>
              <div className="flex flex-wrap items-center gap-2 mb-1.5">
                <span className="px-2.5 py-0.5 rounded-lg text-xs font-bold bg-purple-50 text-purple-700 border border-purple-200 flex items-center gap-1">
                  <span>👑</span>
              ...
              <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">
                Admin Automation & Webhook Control
              </h1>
              <p className="text-xs sm:text-sm text-slate-500 mt-1 max-w-2xl leading-relaxed">
                Real-time pipeline monitoring, webhook environment routing, and multi-tenant telemetry.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 shrink-0 pt-4 md:pt-0 border-t md:border-t-0 border-slate-100">
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-xs font-bold text-slate-700 transition-colors flex items-center gap-2 cursor-pointer shadow-2xs"
            >
