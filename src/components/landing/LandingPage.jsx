...
export default function LandingPage({ onGetStarted, onSignIn }) {
  ...
  const profiles = [
    {
      ...
      title: "Hireley",
      tagline: "Autonomous Capability Auditing",
      description: "Shifts recruitment from subjective manual resume screening to objective, high-fidelity capability auditing. Target recruitment agencies and executive search firms with scientific precision.",
      icon: Briefcase
    },
    {
      id: "merotix",
      badge: "Travel & Tours",
      title: "MeroTix",
      tagline: "Extraordinary Travel Experiences",
      description: "Global travel marketplace helping travelers discover and book the best tours, activities, and boutique stays worldwide. Target tour operators and hospitality leaders.",
      icon: Compass
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans selection:bg-emerald-600 selection:text-white flex flex-col">
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-2xs">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs font-semibold text-slate-600">
            ...
            <a href="#profiles" className="hover:text-emerald-700 transition-colors">Target Ventures</a>
      ...
      {/* 4. Target Venture Spotlights (Hireley & MeroTix) */}
      <section id="profiles" className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <span className="text-xs font-bold uppercase tracking-wider text-emerald-700">
              Target Profiles
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-1">
              Pre-Configured Campaign Blueprints
            </h2>
            <p className="text-xs sm:text-sm text-slate-500 mt-2">
              Tailored value pitches and industry search criteria ready to deploy out-of-the-box.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-6 pt-5 border-t border-slate-200 flex items-center justify-between">
                    <span className="text-xs text-slate-500 font-medium">Template Ready</span>
                    <button
                      type="button"
                      onClick={onGetStarted}
